...
const MeetingPopUp = ({ user, setMeetingHistory }) => {
  ...
  if (lastMeetings.length !== 0) {
    return (
        <div className={"w-full h-full absolute flex lg:items-center justify-center top-0 right-0 backgroundShadow "}>
          <div className={"py-6 px-4  border-2 lg:w-3/12 h-fit mt-40 lg:mt-0  bg-white z-10 drop-shadow-xl flex flex-col gap-4 z-30  "}>
