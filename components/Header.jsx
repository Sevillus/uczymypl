        ...
        >
            <div className={"flex-between mt-2 lg:mt-0"}>
                ...
                <div className={"burgerMenu flex-center relative lg:hidden"}>
                    <div className={"padding-y padding-x w-full h-full flex flex-col gap-10"}>
                        <CloseIcon className={"text-black absolute right-2"} onClick={handleMenuClick}/>
            ...
            >
                ...
                <Link href={"/teacher/schedule"}>
                    <EventNoteIcon
                        className={cn(pathname === "/teacher/schedule" ? "text-blue-500" : "")}
                    />
                </Link>
                <Link href={"/teacher/students"}>
                    <GroupIcon
                        className={cn(pathname === "/teacher/students" ? "text-blue-500" : "")}
                    />
                </Link>
